...
import com.example.thenewsflash.util.Constance.Companion.SEARCH_NEWS_TIME_DELAY
            ...
            when(response){
                ...
                is Resource.Error -> {
                    ...
                    response.message?.let { message ->
                        Toast.makeText(activity, "Sorry an error has occured: $message" , Toast.LENGTH_LONG).show()
